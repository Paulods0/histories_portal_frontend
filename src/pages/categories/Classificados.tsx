  ...
  return (
    <div className="w-full min-h-screen gap-10 lg:px-12 lg:mb-12 flex-col">
      <p className="w-full items-center text-justify gap-x-3 flex font-normal lg:text-xl text-base font-Oswald mt-6 mb-10">
        ...
        na montra. Esta plataforma de anúncios compra/venda é exclusiva para os
        membros da comunidade Clube Overland Angola. Tens um negócio
      ...
      <p className="w-full items-center text-justify gap-x-3 flex font-normal lg:text-xl text-base font-Oswald mt-6 mb-10">
        ...
        responsabilidade nas transações. Em caso de alguma irregularidade deves
