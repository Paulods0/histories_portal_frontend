...
const WriteForUs = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Escreve Para Nós | Overland</title>
        <meta
          name="description"
          content="Partilha a tua aventura overland! Conta a tua história e inspira
            outros exploradores! Escreve sobre o teu passeio overland, paisagens
            e momentos inesquecíveis. Adiciona fotos, dicas e detalhes para
            tornar a narrativa envolvente. Daremos os devidos créditos e
            publicaremos o teu conteúdo."
        />
      </Helmet>
      <FadeInEffect>
